    ...
    render() {
        return (
            <div className="w-full h-scceen" id="About">
                <div className='w-full h-screen bg-gray-900/95 absolute'>
                    <img className="w-full h-screen object-cover mix-blend-overlay" src={aboutusBg} alt="/" />
                </div>
                
                <div className='max-width-[1240px] mx-auto text-white relative pt-8'>
                    <div className='p-10'>
                        <h2 className='pt-2 text-[1.1rem] md:text-[1.2rem] text-slate-300 font-bold uppercase text-center'>About Us</h2>
                        <h3 className='py-6 text-3xl md:text-5xl font-bold text-slate-300 text-center'>We Make Things Easier For You</h3>
                        <p  className='py-4 text-[rem] md:text-2xl md:p-12 text-slate-300 text-center'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-1 sm:pt-1 text-black'>
                        <div className='bg-white rounded-xl shadow-xl'>
                            <div className="p-8">
                                <AiOutlineSearch size="56" className="w-16 p-4 bg-blue-800 text-white rounded-lg mt-[-4rem]" />
                                <h3 className="font-bold text-2xl my-4">Search for Proteins</h3>
                                <p className="text-gray-600 text-[1.2rem]">Find everything you need</p>
                            </div>
                            <div className="bg-slate-100 pl-8 py-4 hover:bg-slate-600 hover:text-slate-100">
                        ...
                        <div className='bg-white rounded-xl shadow-xl'>
                            <div className="p-8">
                                <AiOutlineReconciliation size="56" className='w-16 p-4 bg-blue-800 text-white rounded-lg mt-[-4rem]' />
                                <h3 className="font-bold text-2xl my-4">Compare your Data</h3>
                                <p className="text-gray-600 text-[1.2rem]">From different databases</p>
                            </div>
                            <div className="bg-slate-100 pl-8 py-4 hover:bg-slate-600 hover:text-slate-100">
                        ...
                        <div className='bg-white rounded-xl shadow-xl'>
                            <div className="p-8">
                                <AiTwotoneExperiment size="56" className='w-16 p-4 bg-blue-800 text-white rounded-lg mt-[-4rem]' />
                                <h3 className="font-bold text-2xl my-4">Use your Findings</h3>
                                <p className="text-gray-600 text-[1.2rem]">To get results</p>
                            </div>
                            <div className="bg-slate-100 pl-8 py-4 hover:bg-slate-600 hover:text-slate-100">
                                <a href="" className="flex items-center font-bold text-[1.1rem]">
