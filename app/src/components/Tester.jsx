  ...
  render() {
    return (
      <div className="w-screen h-20">
        ...
        <aside id="cta-button-sidebar h-20" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
