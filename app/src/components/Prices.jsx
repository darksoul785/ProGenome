...
import { GiSchoolBag, GiArchiveResearch, GiRoundStar, GiAtomicSlashes, GiAtom } from "react-icons/gi"

class Prices extends React.Component {

    render() {
        return (
            <div className='w-full h-screen my-20 lg:mt-24 lg:pt-12' id="Prices">
                <div className='max-w-[1240px] mx-auto h-full'>
                    ...
                    <div className="w-full py-[2rem] px-4 bg-white text-black">
                        <div className="max-w-[1240px] mx-auto grid md:grid-cols-4 grid-cols-2 gap-6">
                            <div className="w-full shadow-md hover:shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale(105) duration-300 bg-slate-50">
                                <GiAtomicSlashes size="68" className="w-20 p-4 bg-gray-600 text-white rounded-lg mx-auto mt-[-3rem]" />
                            ...
                            <div className="w-full shadow-md hover:shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale(105) duration-300 bg-slate-50">
                                <GiSchoolBag size="68" className="w-20 p-4 bg-gray-600 text-white rounded-lg mx-auto mt-[-3rem]" />
                            ...
                            <div className="w-full shadow-md hover:shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale(105) duration-300 bg-slate-50">
                                <GiArchiveResearch size="68" className="w-20 p-4 bg-gray-600 text-white rounded-lg mx-auto mt-[-3rem]" />
                            ...
                            <div className="w-full shadow-md hover:shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale(105) duration-300 bg-slate-50">
                                <GiRoundStar size="68" className="w-20 p-4 bg-gray-600 text-white rounded-lg mx-auto mt-[-3rem]" />
